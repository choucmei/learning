package chouc.algorithm.leetcode_interview;
 ...
 * @date 2021/5/17
 */
public class I0814SolveNQueens {
    public List<List<String>> solveNQueens(int n) {
        List<List<String>> solutions = new ArrayList<>();
        int[] queens = new int[n];
        Arrays.fill(queens, -1);
        Set<Integer> columns = new HashSet<>(n);
        Set<Integer> x1 = new HashSet<>(n);
        Set<Integer> x2 = new HashSet<>(n);
        backtrack(solutions, queens, n, 0, columns, x1, x2);
        return solutions;
    }
