package chouc.java.proxy.action;

import chouc.java.proxy.impl.Boss;
import chouc.java.proxy.proxyclass.ProxyBoss;
import chouc.java.proxy.service.IBoss;
...
public class ProxySaleAction {
	...
	@Test
	public void sale(){
		IBoss boss = ProxyBoss.getMyProxy(IBoss.class,Boss.class,0.8f);
		System.out.println(boss.yifu("xxl"));
	}
