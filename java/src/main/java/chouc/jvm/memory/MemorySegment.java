...
public final class MemorySegment {
    ...
    private static long getClassFieldOffset(
        ...
        try {
            ...
            throw new Error(", permission denied by security manager.",
                    e);
        } catch (NoSuchFieldException e) {
            throw new Error(e);
        } catch (Throwable t) {
            throw new Error(", unclassified error", t);
        }
    }
     ...
     */
    MemorySegment(ByteBuffer buffer, Object owner) {
    ...
    public void get(int index, byte[] dst, int offset, int length) {
        ...
        if (index >= 0 && pos <= addressLimit - length) {
            ...
            System.out.println(heapMemory + " " + pos + " " + arrayAddress + length);
