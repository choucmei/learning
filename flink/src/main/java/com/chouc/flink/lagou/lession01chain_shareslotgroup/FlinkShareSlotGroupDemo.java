 ...
 * @date 2021/2/4
 */
public class FlinkShareSlotGroupDemo {
...
//        env.disableOperatorChaining();
        ...
        SingleOutputStreamOperator<String> streamOperator = env
                .addSource(new SocketTextStreamFunction("localhost",9999,"\t",1000))
                .slotSharingGroup("group0")
        ...
        mapStream.keyBy(0)
                .sum(1).slotSharingGroup("group0")
                .print().slotSharingGroup("group0");
